...
>
    ...
    <nav class="mt-16 sm:mt-0">
        <div class="mt-12 px-8">
            ...
            <div class="mt-3">
                <a href="{{ route(home_route()) }}" class="-mx-3 px-3 py-2 flex items-center justify-between text-sm font-medium bg-gray-200 rounded-lg">
                    <span class="inline-flex items-center">
                        <svg class="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <span class="ml-2 text-gray-900">Dashboard</span>
                    </span>
                </a>
                <a href="#" class="mt-2 -mx-3 px-3 py-2 flex items-center justify-between text-sm font-medium hover:bg-gray-200 rounded-lg">
                    <span class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-gray-700">Tutoriels</span>
                    </span>
                ...
                <a href="#" class="mt-2 -mx-3 px-3 py-2 flex items-center justify-between text-sm font-medium hover:bg-gray-200 rounded-lg">
                    <span class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-gray-700">Forum</span>
                    </span>
                </a>
                <a href="#" class="mt-2 -mx-3 px-3 py-2 flex items-center justify-between text-sm font-medium hover:bg-gray-200 rounded-lg">
                    <span class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-gray-700">Jobs</span>
                    </span>
                </a>
            </div>
            <h2 class="mt-8 text-xs font-semibold text-gray-600 uppercase tracking-wide">Configuration</h2>
            <div class="mt-4">
                <a href="#" class="block text-sm font-medium text-gray-700">Logs</a>
                <a href="#" class="mt-4 block text-sm font-medium text-gray-700">Audits</a>
                <a href="#" class="mt-4 block text-sm font-medium text-gray-700">Backups</a>
            </div>
        </div>
