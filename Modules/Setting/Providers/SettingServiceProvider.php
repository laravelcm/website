...
class SettingServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app['events']->listen(BuildingSidebar::class, RegisterSettingSidebar::class);
    }
    ...
    {
        $viewPath = resource_path('views/vendor/modules/setting');
    ...
    {
        $langPath = resource_path('lang/vendor/setting');
