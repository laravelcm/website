...
@section('title', "Créer un nouveau tutoriel")

@section('content')

    @component('components.breadcrumb')
        <a href="{{ route('admin.tutorials.index') }}" class="text-gray-500 hover:text-gray-700 focus:outline-none focus:underline transition duration-150 ease-in-out">Tous les articles</a>
    @endcomponent

    <div class="mt-2 md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:leading-9 sm:truncate">
                {{ __('Créer un tutoriel') }}
            </h2>
        </div>
    </div>

    <div class="py-8">
        {!! Form::open(['route' => 'admin.tutorials.store', 'files' => true]) !!}
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    {!! Form::text('title', null, [
                                            ...
                                            'id' => 'title',
                                            'autocomplete' => 'off',
                                            'placeholder' => "Ex. Comment utiliser la classe Request,..."
                                        ])
                                    !!}
                                </div>
                            </div>
