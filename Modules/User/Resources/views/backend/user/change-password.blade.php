...
@section('title', __('user::labels.backend.access.users.management') . ' | ' . __('user::labels.backend.access.users.change_password'))
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">@lang('user::labels.backend.access.users.change_password')</small>
                        </h4>

                        <div class="small text-muted">
                            @lang('user::labels.backend.access.users.change_password_for', ['user' => $user->name])
                        </div>
                    </div><!--col-->
                </div><!--row-->
