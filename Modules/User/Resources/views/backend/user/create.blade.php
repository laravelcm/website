...
@section('title', __('user::labels.backend.access.users.management') . ' | ' . __('user::labels.backend.access.users.create'))
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('user::labels.backend.access.users.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('user::labels.backend.access.users.table.abilities'))->class('col-md-2 form-control-label') }}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('user::labels.backend.access.users.table.permissions')</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            @if($role->id != 1)
                                                                ...
                                                                @endif
                                                            @else
                                                                @lang('user::labels.backend.access.users.all_permissions')
                                                            @endif
                                                        </div>
                                                    </div><!--card-->
                                                @endforeach
