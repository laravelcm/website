...
@section('title', __('user::labels.backend.access.users.management') . ' | ' . __('user::labels.backend.access.users.deactivated'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('user::labels.backend.access.users.deactivated')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
