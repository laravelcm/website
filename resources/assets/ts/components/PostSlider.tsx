...
export default ({ title, image }: Props) => {
  return (
    <div className="w-full md:w-1/2 md:mb-5 lg:w-1/4 lg:mb-6 md:px-4">
      <InertiaLink className="block rounded-lg bg-white h-56 shadow-md hover:shadow-lg" href="/">
        <img src={image} className="bg-cover w-full h-45 rounded-t-lg" alt={title} />
