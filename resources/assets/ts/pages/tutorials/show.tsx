            ...
            <div className="flex items-start space-x-8 lg:flex-col lg:space-x-0">
              <div className="w-1/3 lg:w-full lg:mb-4">
                <h5 className="text-base font-medium text-gray-700 mb-3 flex items-center">
                  <svg className="h-4 w-4 text-gray-700 mr-2" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 13.965l-4.912 2.453A.75.75 0 013 15.75V3c0-.825.675-1.5 1.5-1.5h9A1.5 1.5 0 0115 3v12.75a.75.75 0 01-1.088.675L9 13.957v.008zM13.5 3h-9v11.535l4.162-2.078a.75.75 0 01.675 0l4.163 2.078V3z" fill="currentColor" />
                  </svg>
                  <span>Categorie</span>
                </h5>
                <div>
              ...
              <div className="flex items-center w-1/3 lg:w-full space-x-2 mb-3">
                <svg className="h-4 w-4 fill-current mr-2 text-gray-700" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-base font-medium text-gray-700">Vues</span>
                <span className="text-base text-gray-800">2040</span>
              </div>
            </div>
          </div>
          <div className="w-full order-2 lg:w-8/12">
            <h1 className="text-xl text-gray-800 font-medium">Laravel App on Digital Ocean Ubuntu 19.04 droplet (Step by Step Guide)</h1>
            <div className="flex mt-6 lg:mt-14 items-center">
              <img src="https://avatars2.githubusercontent.com/u/14105989?s=460&v=4" className="h-12 w-12 rounded-full mr-4" alt="Arthur Monney" />
              <div className="flex flex-col">
                <h4 className="text-base text-gray-600">
                  Auteur <a className="font-medium text-brand-primary hover:text-brand-900" href="https://github.com/mckenziearts" target="_blank" rel="noopener noreferrer">Arthur Monney</a>
                </h4>
                <small className="text-xs text-gray-500">Le 12 Janvier, 2020</small>
              </div>
            </div>
            <div className="body-content mt-8 lg:mt-18 text-sm lg:text-base text-gray-600 relative">
              ...
              <div className="flex mt-8 lg:hidden items-center">
                <p className="text-base text-gray-600 mr-3">Partager cette article :</p>
