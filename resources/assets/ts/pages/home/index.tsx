  ...
  return (
    <>
      ...
      <div className="container mt-8">
        <div className="w-full space-y-4 mb-10 md:flex flex-grow md:space-y-0 md:space-x-18 lg:-mt-32 lg:mb-14">
          <InertiaLink href="/jobs" className="flex p-4 bg-white rounded-lg shadow-md hover:shadow-lg w-full cursor-pointer items-center md:flex-col md:text-center md:w-1/3 md:px-5 lg:py-8 lg:px-6">
        ...
        <div className="mb-14 relative lg:mb-18">
          <Slider {...settings}>
            <div>
              <PostSlide
