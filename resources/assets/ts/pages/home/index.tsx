    ...
    <>
      ...
      <div className="container mt-8 md:px-4">
        <div className="w-full space-y-4 mb-10 md:flex flex-grow md:space-y-0 md:space-x-8 lg:space-x-18 lg:-mt-32 lg:mb-14">
          ...
          <InertiaLink href="/forum" className="flex p-4 bg-white rounded-lg shadow-md hover:shadow-lg w-full cursor-pointer items-center md:flex-col md:text-center md:w-1/3 md:px-5 lg:py-8 lg:px-10">
            <span className="bg-brand-primary p-3 rounded-full flex items-center justify-center mr-4 md:mr-0 md:mb-3">
              <svg className="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg">
          ...
          <InertiaLink href="/slack" className="flex p-4 bg-white rounded-lg shadow-md hover:shadow-lg w-full cursor-pointer items-center md:flex-col md:text-center md:w-1/3 md:px-5 lg:py-8 lg:px-10">
            <span className="bg-brand-primary p-3 rounded-full flex items-center justify-center mr-4 md:mr-0 md:mb-3">
              <svg className="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul>
                ...
                <li className="border-b border-green-700 py-3">
                  <InertiaLink href="/" className="flex items-center hover:text-gray-200">
                    ...
                    <span className="text-sm">Check out my latest creation :D by: <span className="font-semibold">Kevin Dark</span></span>
                  </InertiaLink>
                </li>
                <li className="border-b border-green-700 py-3">
                  <InertiaLink href="/" className="flex items-center hover:text-gray-200">
                    ...
                    <span className="text-sm">Is Webble down for you guys? by: <span className="font-semibold">Neville Griff</span></span>
                  </InertiaLink>
                </li>
                <li className="border-b border-green-700 py-3">
                  <InertiaLink href="/" className="flex items-center hover:text-gray-200">
                    ...
                    <span className="text-sm">How can i add icons to my build? by: <span className="font-semibold">Diane Lay</span></span>
                  </InertiaLink>
                </li>
              </ul>
            </div>
