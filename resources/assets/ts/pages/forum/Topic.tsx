    ...
    <div className="bg-gradient-white py-4 lg:hidden">
      <div className="container">
        <h1 className="text-lg md:text-xl text-gray-800">
            problème lié au dossier " public " de laravel
        </h1>
      </div>
    </div>
      ...
      <div className="flex w-full">
        ...
        <div className="w-full lg:pl-12 lg:w-9/12">
          <div className="bg-gray-100 flex flex-col px-6 py-4 rounded-lg">
            ...
            <div className="mt-6">
              <p>
                  Bonjour, Après déploiement de mon site web conçu avec laravel
                  chez l'hébergeur LWS, pour accéder au site je veux utiliser
                  l'adresse www.mondomain.com au lieu de www.domaine.com/public.
                  comment procéder? Voila je rencontre un petit problème avec
                  mon code. Ce que je fais www.domaine.com/public``` Ce que je
                  veux www.mondomain.com Ce que j'obtiens Décrivez ici vos
                  erreurs ou ce que vous obtenez à la place de ce que vous
                  attendez :(
              </p>
            </div>
          </div>
