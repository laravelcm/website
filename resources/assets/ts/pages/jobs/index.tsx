  ...
  return (
    <>
      ...
      <div className="pt-10 pb-12 bg-gradient-white lg:pt-20 lg:pb-24 lg:h-125 relative">
        <img src={require("@/assets/images/job-illustration.svg")} className="hidden lg:block absolute right-0" style={{ top: "32px", right: "100px" }} alt="illustration" />
        <div className="container">
          <div className="w-full lg:w-1/2">
            <h1 className="text-brand-primary text-2xl md:text-3xl mb-6 lg:text-4xl lg:mb-8 font-bold">Votre passion commence ici !</h1>
            <p className="text-sm mb-10 lg:w-140 lg:text-sm lg:mb-10">
              Votre futur dépendra du travail que vous allez obtenir aujourd’hui. Rejoignez plusieurs autres rechercheurs
              et demandeurs d’emploi. La meilleure façon de trouver un nouveau job.
            </p>
            <div className="mb-3">
              ...
              <small className="text-xs text-gray-700">Plus de 1000 offres postées par environs 50 sociétes.</small>
            </div>
      ...
      <div className="container mt-12 lg:mt-20">
        <div className="flex">
          <div className="hidden lg:block w-3/12 space-y-8">
            <div className="flex justify-between items-end">
              <h4 className="text-xl font-medium text-gray-900">Filtres</h4>
              <button className="flex text-sm items-center" type="button">
                <svg className="h-4 w-4 text-gray-600 mr-1" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3.079 7.222h-1.16A6.38 6.38 0 018.294.848a6.38 6.38 0 016.373 6.374c0 3.459-2.77 6.28-6.21 6.368v1.743l-2.608-2.317 2.608-2.319v1.736a5.221 5.221 0 005.052-5.21 5.22 5.22 0 00-5.215-5.215A5.22 5.22 0 003.08 7.222z" fill="currentColor" />
                </svg>
              ...
              <div className="space-y-2">
                <div>
                  <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox text-brand-primary" />
                ...
                <div>
                  <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox text-brand-primary" />
                    <span className="ml-2 text-gray-800">Temps partiel (20)</span>
                  </label>
                </div>
                <div>
                  <label className="inline-flex items-center">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div>
                  <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox text-brand-primary" />
                    <span className="ml-2 text-gray-800">Ile de France (29)</span>
                  </label>
                </div>
                <div>
                  <label className="inline-flex items-center">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div>
                  <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox text-brand-primary" />
                    <span className="ml-2 text-gray-800">Bureau ou télé-travail</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between lg:items-center lg:flex-row mb-8">
              ...
              <div className="flex items-center space-x-2">
                <button type="button" className="flex items-center">
                  ...
                  <span className="text-gray-800 font-medium">Date de publication</span>
                  <svg className="h-6 w-6 text-gray-600 ml-1" xmlns="http://www.w3.org/2000/svg">
