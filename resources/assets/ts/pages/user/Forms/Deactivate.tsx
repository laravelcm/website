...
export default () => {
  function deactivate(e: React.SyntheticEvent) {
    e.preventDefault();
  }
            ...
            <div className="shadow overflow-hidden sm:rounded-md border border-red-300">
              <div className="bg-white">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <div className="mt-5">
                    <button type="submit" className="inline-flex items-center justify-center px-4 py-2 border border-transparent font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-50 focus:outline-none focus:border-red-300 focus:shadow-outline-red active:bg-red-200 transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                      Désactiver
                    </button>
                  </div>
                </div>
