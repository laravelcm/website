  ...
  <>
    ...
    <div className="container">
      <div className="pt-10 lg:w-3/4 lg:mx-auto">
        <h1 className="text-xl text-gray-800 mb-8 lg:mb-10 font-medium sm:text-2xl md:text-3xl lg:text-5xl">
            Create Flexible Notification with Laravel Notify
        </h1>
        ...
        <div className="body-content lg:w-5/6 lg:mx-auto mt-8 lg:mt-18 text-sm lg:text-base text-gray-600 relative">
          <div>
              ...
              est facere possimus voluptatem. A aliquam consectetur, dignissimos
              enim et hic in nostrum quae quas qui quibusdam quod ratione
          ...
          <div>
              Ad atque commodi consectetur cumque et fugit magni, maiores neque
              nesciunt, nostrum obcaecati perspiciatis qui quo repellat
              temporibus veritatis voluptatibus! Distinctio in nemo officiis
              porro repudiandae totam. Incidunt, provident, recusandae?
          </div>
          <div>
              Aspernatur at eos eveniet excepturi, hic in ipsa ipsam laboriosam,
              maiores, obcaecati placeat voluptatibus! Amet asperiores, atque
              consequatur, ex facere labore, maxime nemo non officiis optio quod
              ratione sit vel!
          </div>
          <div>
          ...
          <div>
              Aliquid assumenda beatae consequuntur cupiditate delectus dolorem
              ducimus, hic illum impedit minima molestias nam nihil non
              perspiciatis porro praesentium quae quos ratione recusandae
              repudiandae totam ullam ut vel vero vitae!
          </div>
          <div>
              Adipisci et illum iusto omnis qui, repudiandae? Alias cupiditate
              earum esse incidunt iure, molestias nemo nihil, nisi nostrum odit
              officia optio pariatur perferendis provident, quae quas quasi
              reiciendis voluptas. Quos.
          </div>
          <div>
              Accusantium, amet architecto asperiores atque delectus dicta
              dignissimos ducimus ea error expedita in laudantium mollitia natus
              non omnis quam quas quos rem repellendus repudiandae saepe
              sapiente sint sit velit voluptatem.
          </div>
          <div>
              Distinctio dolore, ducimus eius facere fugiat illum impedit maxime
              molestias nemo, pariatur possimus reiciendis veniam veritatis vero
              voluptate. Aperiam eligendi facilis ipsum libero minima quaerat,
              qui velit? Enim, illo sequi.
          </div>
          <div>
              Aspernatur assumenda commodi consequatur cumque dolorum ducimus ea
              exercitationem, facere illo, iure magnam maxime nulla officia
              quaerat unde voluptates voluptatibus! Commodi distinctio dolore
              incidunt, inventore iste itaque laboriosam rerum saepe!
          </div>
          <div
            className="flex mt-8 items-center lg:absolute top-0"
            style={{ left: "-70px" }}
          >
