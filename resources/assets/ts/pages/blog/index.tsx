        ...
        <div className="container">
          ...
          <div className="text-center overflow-hidden overflow-x-scroll hidden-scrollbar">
            <ul className="text-sm inline-flex">
              ...
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">React Native</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">VueJS</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">Flutter</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">Hosting</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">Firebase</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">JavaScript</InertiaLink></li>
              <li className="inline-block mr-6"><InertiaLink href="/" className="text-gray-700 hover:text-gray-600">Design</InertiaLink></li>
            </ul>
          </div>
        </div>
      </div>
