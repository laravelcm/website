        ...
        <div className="flex items-center -mx-6">
          <div className="lg:w-1/2 pl-6 pr-6 lg:pr-8">
            <div className="flex flex-grow items-center">
              ...
              <nav className="hidden lg:block flex pl-15">
                <a href="/blog" className="text-gray-800 mr-4 hover:text-gray-600">Blog</a>
                <a href="/tutorials" className="text-gray-800 mr-4 hover:text-gray-600">Tutoriels</a>
                <a href="/forum" className="text-gray-800 mr-4 hover:text-gray-600">Forum</a>
                <a href="/packages" className="text-gray-800 mr-4 hover:text-gray-600">Packages</a>
              </nav>
            </div>
          </div>
          <div className="lg:w-1/2 flex flex-grow lg:pr-6">
            ...
            <div className="hidden lg:flex items-center pl-4">
              <a href="/login" className="text-brand-primary mr-4">Connexion</a>
              <a href="/register" className="btn btn-primary">M'inscrire</a>
            </div>
          </div>
        </div>
      </div>
