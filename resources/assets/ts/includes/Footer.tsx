          ...
          <div className="md:flex w-full lg:w-2/3 lg:pl-24">
            ...
            <div className="px-6 mb-8 md:w-1/3">
              ...
              <ul>
                <li className="mb-3">
                  <a
                    href="https://facebook.com/laravelcm"
                    className="text-gray-700 hover:text-gray-800"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li className="mb-3">
                  <a
                    href="https://twitter.com/laravelcm"
                    className="text-gray-700 hover:text-gray-800"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li className="mb-3">
                  <a
                    href="https://github.com/laravelcm"
                    className="text-gray-700 hover:text-gray-800"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <li className="mb-3">
                  <a
                    href="https://www.youtube.com/channel/UCbQPQ8q31uQmuKtyRnATLSw"
                    className="text-gray-700 hover:text-gray-800"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
