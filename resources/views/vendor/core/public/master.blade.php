...
<head>
    ...
    <meta property="og:title" content="@yield('ogTitle') - {{ $websiteTitle }}">
    <meta property="og:description" content="@yield('description')">
    <meta property="og:url" content="{{ URL::full() }}">
    <meta property="og:langage" content="{{ config('app.locale') }}">
    <meta property="og:image" content="@yield('image')">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@laravelcm">
    <meta name="twitter:creator" content="@laravelcm">
    <meta name="twitter:url" content="{{ URL::full() }}">
    <meta name="twitter:title" content="@yield('ogTitle') - {{ $websiteTitle }}">
            ...
            <nav class="site_nav" id="site_nav">
                <div class="container">
                    <div class="nav_header">
                        <a href="{{ TypiCMS::homeUrl() }}" class="nav__logo">
                            ...
                            <span class="logo__title">{{ TypiCMS::title() }}</span>
                        </a>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <ul class="footer-links">
                    {{--<li class="link__tutorials"><a href="javascript:;">{{ __('Tutorials') }}</a></li>
                    <li class="link__events"><a href="https://laravelevents.com">{{ __('Events') }}</a></li>
                    <li class="link__packages"><a href="javascript:;">{{ __('Packages') }}</a></li>
