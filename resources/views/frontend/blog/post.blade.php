...
@section('meta')
    <meta name="description" content="{{ str_limit($post->excerpt, 150) }}">
    <!-- Facebook Meta -->
    <meta property="og:url" content="{{ route('blog.post', ['slug' => $post->slug]) }}">
    <meta property="og:title" content="{{ $post->seo_title }} - Laravel Cameroon">
    <meta property="og:image" content="{{ asset("storage/$post->image") }}">
    <meta property="og:description" content="{{ str_limit($post->excerpt, 150) }}">
    <!-- Twitter Meta -->
    <meta name="twitter:url" content="{{ route('blog.post', ['slug' => $post->slug]) }}">
    <meta name="twitter:title" content="{{ $post->seo_title }} - Laravel Cameroon">
    <meta name="twitter:description" content="{{ str_limit($post->excerpt, 150) }}">
